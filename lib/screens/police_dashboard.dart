...
void initState() {
  ...
  final fakeAlerts = [
    ...
    {'guestName': 'Suspicious Entry', 'hotelName': 'Metro Stay'},
  ];
  ...
  return ListView.builder(
    ...
    itemCount: fakeAlerts.length,
    itemBuilder: (context, index) {
      final g = fakeAlerts[index];
      ...
      return Container(
        ...
        child: ListTile(
          ...
          title: Text(g['guestName'] ?? "Unknown"),
         subtitle: Text("At Hotel: ${g['hotelName'] ?? 'N/A'}"),
        ),
      );
    },
  );
